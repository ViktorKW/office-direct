...
const itemsArray = [{
    img:chair,
    header:"Кресло Samurai KL-1.04",
    desc:"Характеристики, цвет, механизм и прочее Артикул: 266-460",
    initPrice:27000,
    currentPrice:23000,
    quantity:1
},{
    img:chair,
    header:"Кресло Murasama KL-1.04",
    desc:"Характеристики, цвет, механизм и прочее Артикул: 266-460",
    initPrice:15000,
    currentPrice:12000,
    quantity:4
    ...
    subforms: [
        {
            ...
            array: [
                ...
                },
                {
                    name:"radioInput",
                    inputName:'payment',
                    header:"Payment by Bank card (VISA, MasterCard, Maestro) without commission upon delivery through a payment terminal",
                },
            ]
        }
    ]
