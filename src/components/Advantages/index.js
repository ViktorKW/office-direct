  ...
  return (
    <div className='advantages'>
      <div className='feature'>
        ...
        <p>
          <strong>Free shipping</strong> across Kyiv and Odesa — minimum 3
          products
        </p>
      ...
      <div className='feature'>
        ...
        <p>
          <strong>Individual discounts</strong> when ordering from 3 products
        </p>
      ...
      <div className='feature'>
        ...
        <p>
          <strong>Special conditions</strong> apply for legal entities
        </p>
        <a href='#'>Learn more</a>
      </div>
    </div>
